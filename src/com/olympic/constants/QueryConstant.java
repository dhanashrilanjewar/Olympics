...
public class QueryConstant {
    ...
    public final static String INSERT_PLAYER_QUERY = "insert into player (playerId, name, dob, gameType, country, email, username, password, userType) values (?,?,?,?,?,?,?,?,?)";
    ...
    public final static String UPDATE_PLAYER = "update player set name=?, DOB=?, gameType=?, country=?, email=? where playerId=";
    ...
    public final static String GET_PLAYER_BY_USERNAME = "select * from player where userName='";
}
